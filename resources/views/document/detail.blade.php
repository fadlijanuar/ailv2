...
<div class="card shadow mb-4">
  <div class="card-body">
    <div class="row">
      <div class="col-md-12">
        <form action="{{ url('/admin/dokumen_pelanggan/'.$customer->id) }}" method="post" enctype="multipart/form-data">
          @csrf
          @method('put')
          <div class="row">
            <div class="col-md-4">
            ...
            <div class="col-md-4">
              {{-- TODO: membuat tampilan juka tidak ada gambar --}}
            ...
            <div class="col-md-4">
              <iframe width="100%" height="400px" src="{{ asset('document_pelanggan/jawaban_persetujuan/'.$customer->jawaban_persetujuan) }}" type="pdf"></iframe>
              <div class="form-group">
